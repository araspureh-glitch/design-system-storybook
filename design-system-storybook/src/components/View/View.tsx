...
/**
 * **Preserved Figma Layer Name**: `view`
 * Page: `date and time`
 * Type: `COMPONENT_SET`
 * ID: `181:6775`
 */
...
<div style={{ display: 'flex', flexDirection: 'row', gap: '8px', padding: '4px 8px', borderRadius: '6px', background: 'rgba(255,255,255,0.03)', alignItems: 'center' }}>
<div style={{ display: 'flex', flexDirection: 'row', gap: '8px', padding: '4px 8px', borderRadius: '6px', background: 'rgba(255,255,255,0.03)', alignItems: 'center' }}>
<span style={{ fontSize: '14.744926452636719px', fontWeight: 600, color: 'rgb(0, 0, 0)', display: 'inline-block' }}>View</span>
</div>
</div>
...
<div style={{ display: 'flex', flexDirection: 'row', gap: '8px', padding: '4px 8px', borderRadius: '6px', background: 'rgba(255,255,255,0.03)', alignItems: 'center' }}>
<div style={{ display: 'flex', flexDirection: 'row', gap: '8px', padding: '4px 8px', borderRadius: '6px', background: 'rgba(255,255,255,0.03)', alignItems: 'center' }}>
<span style={{ fontSize: '14.744926452636719px', fontWeight: 600, color: 'rgb(255, 255, 255)', display: 'inline-block' }}>View</span>
</div>
</div>
...
<span style={{ fontSize: '16px', fontWeight: 400, color: 'rgb(0, 0, 0)', display: 'inline-block' }}>Yearly</span>
<span style={{ fontSize: '16px', fontWeight: 400, color: 'rgb(0, 0, 0)', display: 'inline-block' }}>Monthly</span>
<div style={{ display: 'flex', flexDirection: 'row', gap: '8px', padding: '4px 8px', borderRadius: '6px', background: 'rgba(255,255,255,0.03)', alignItems: 'center' }}>
<div style={{ display: 'flex', flexDirection: 'row', gap: '8px', padding: '4px 8px', borderRadius: '6px', background: 'rgba(255,255,255,0.03)', alignItems: 'center' }}>
<span style={{ fontSize: '14.744926452636719px', fontWeight: 600, color: 'rgb(255, 255, 255)', display: 'inline-block' }}>View</span>
</div>
