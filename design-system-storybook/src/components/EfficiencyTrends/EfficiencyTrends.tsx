...
/**
 * **Preserved Figma Layer Name**: `Efficiency trends`
 * Page: `charts`
 * Type: `COMPONENT_SET`
 * ID: `180:4460`
 */
export const EfficiencyTrends: React.FC<EfficiencyTrendsProps> = ({
  ...
  return (
    <div 
      className={`efficiencytrends-container ${className}`}
      style={style}
...
<span style={{ fontSize: '11px', color: 'var(--uedp-slate-400, #94a3b8)' }}>Rectangle 700</span>
</div>
