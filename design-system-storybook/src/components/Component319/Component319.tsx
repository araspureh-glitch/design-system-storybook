...
export const Component319: React.FC<Component319Props> = ({
  ...
  return (
    <div 
      className={`component319-container ${className}`}
      style={style}
...
<div style={{ display: 'flex', flexDirection: 'row', gap: '8px', padding: '4px 8px', borderRadius: '6px', background: 'rgba(255,255,255,0.03)', alignItems: 'center' }}>
<span style={{ fontSize: '12px', fontWeight: 500, color: 'rgb(0, 60, 66)', display: 'inline-block' }}>June 2024</span>
</div>
