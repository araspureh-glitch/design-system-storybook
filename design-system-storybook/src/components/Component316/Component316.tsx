...
export const Component316: React.FC<Component316Props> = ({
  ...
  return (
    <div 
      className={`component316-container ${className}`}
      style={style}
...
<span style={{ fontSize: '12px', fontWeight: 400, color: 'rgb(0, 60, 66)', display: 'inline-block' }}>Energy Load: 4.1 MW\r\nRenewable Share: 65%\r\nCarbon Emissions: 1.2 tons\r\nStatus: Moderate Increase</span>
<div style={{ width: '16px', height: '16px', borderRadius: '50%', background: 'rgb(52, 159, 169)', display: 'inline-block', flexShrink: 0 }} />
<div style={{ display: 'flex', flexDirection: 'row', gap: '8px', padding: '4px 8px', borderRadius: '6px', background: 'rgba(255,255,255,0.03)', alignItems: 'center' }}>
<span style={{ fontSize: '12px', fontWeight: 500, color: 'rgb(0, 60, 66)', display: 'inline-block' }}>March 2024</span>
</div>
